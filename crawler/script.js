...
const getSurah = surah => {
   const editions = ['quran-simple-enhanced', 'ar.alafasy', 'en.transliteration', 'en.sahih'];
...
const preBismillahHandler = ayah => {
   const replacer = {
      '%u0628%u0650%u0633%u0652%u0645%u0650 %u0627%u0644%u0644%u0651%u064e%u0647%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0652%u0645%u064e%u0670%u0646%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0650%u064a%u0645%u0650':
         /%u0628%u0650%u0633%u0652%u0645%u0650 %u0627%u0644%u0644%u0651%u064e%u0647%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0652%u0645%u064e%u0670%u0646%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0650%u064a%u0645%u0650/gi,
      '%u0628%u0651%u0650%u0633%u0652%u0645%u0650 %u0627%u0644%u0644%u0651%u064e%u0647%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0652%u0645%u064e%u0670%u0646%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0650%u064a%u0645%u0650':
         /%u0628%u0651%u0650%u0633%u0652%u0645%u0650 %u0627%u0644%u0644%u0651%u064e%u0647%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0652%u0645%u064e%u0670%u0646%u0650 %u0627%u0644%u0631%u0651%u064e%u062d%u0650%u064a%u0645%u0650/gi,
   };
...
const operate = async (surah, tafsirSurah = {}, tryFlag = false) => {
   ...
   try {
      ...
      process.stdout.write(
         `> (${code}:${status}). Operating on surah ${surah}:${arab.englishName}... `
      );
      ...
      const result = {
         ...
         revelation: {
            arab:
               arab.revelationType === 'Meccan'
                  ? '%u0645%u0643%u0629'
                  : '%u0645%u062F%u064A%u0646%u0629',
            en: arab.revelationType,
            id: arab.revelationType === 'Meccan' ? 'Makkiyyah' : 'Madaniyyah',
         },
         tafsir: {
            id: (() => {
...
async function main() {
   ...
   const data = JSON.stringify(
      {
         license: '(MIT) Said Al-Ghiyats (said.ghiyatss@gmail.com)',
